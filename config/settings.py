...
CKEDITOR_CONFIGS = {
    ...
    'advanced': {
        ...
        'height': 400,
        'width': '100%',
        'extraPlugins': ','.join(['font', 'colorbutton', 'justify']), # Garante que os plugins de fonte, cor e justificação estejam ativos
    },
}
...
USE_THOUSAND_SEPARATOR = True # Essencial para o separador de milhar
USE_L10N = True # Essencial para formatação de números e datas
